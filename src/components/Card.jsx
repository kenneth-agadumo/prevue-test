        ...
        <div className="display-card" >
            ...
            <div className="card-info-cont" style={{marginTop:'0'}}>
                <div className="rental-info">
                    <span className="name"><img src="/bed.png" alt="" /> 2 Bedrooms  </span>
                    <span className="name"><img src="/bath.png" alt="" /> 2 Baths</span>
                    <span className="name"><img src="/ruler.png" alt="" /> 1,200 sqft</span>
