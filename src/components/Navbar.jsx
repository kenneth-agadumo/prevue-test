...
export const Navbar = () => {
  ...
  return (
    <nav ref={navRef} style={{ left: isActive ? "0" : "5%" }} className="z-50">
      <Link to="/">
        <img
          src={
      ...
      <div className={`nav-menu ${isActive ? "active" : ""}`}>
        ...
        <ul
          style={{
            color: location.pathname === "/" && { isActive }
              ? "white"
              : "black",
            fontWeight: "500",
          }}
        >
          ...
          <li
            style={{
              color: location.pathname == "/rentals" && "var(--primary-color)",
            }}
          >
            <Link to="/rentals">Shortlets</Link>
          </li>
          <li
            style={{
              color:
                location.pathname == "/restaurants" && "var(--primary-color)",
            }}
          >
          ...
          <li
            style={{
              color:
                location.pathname == "/activities" && "var(--primary-color)",
            }}
          >
